(function exposeAncientEgyptV4(root, factory) {
  const data = factory();
  if (root) root.ATLAS_V4_ANCIENT_EGYPT = data;
  if (typeof module === 'object' && module.exports) module.exports = data;
}(typeof window !== 'undefined' ? window : globalThis, function createAncientEgyptV4Data() {
  'use strict';
  ...
  const entities = [
    { id: 'ancient-egypt-civilization', type: 'culturalTradition', name: '古埃及文明', alternativeNames: ['Ancient Egyptian civilization'], canonicalSummary: '约公元前3100—前30年，形成于尼罗河河谷与三角洲，以法老王权、神庙、象形文字、死后信仰和不断变化的艺术传统延续了近三千年的古代文明。', timeSpan: timeSpan(-3100, -30, '约公元前3100—前30年', true), defaultCardId: 'ancient-egypt-gift-of-nile', tags: ['非洲', '古埃及', '文化传统'], sourceIds: ['source-ucl-narmer', 'source-met-telling-time-egypt', 'source-met-egypt-1000-1'] },
    { id: 'egypt-old-kingdom', type: 'polity', name: '古埃及古王国', alternativeNames: ['Old Kingdom of Egypt'], canonicalSummary: '约公元前2686—前2181年，以统一王权、大型王室陵墓和不断扩展的行政网络为重要特征的古埃及政治实体。', timeSpan: timeSpan(-2686, -2181, '约公元前2686—前2181年', true), defaultCardId: 'egypt-old-kingdom-overview', tags: ['非洲', '古埃及', '政治实体'], sourceIds: ['source-met-old-kingdom', 'source-muller-old-kingdom-end'] },
    { id: 'egypt-middle-kingdom', type: 'polity', name: '古埃及中王国', alternativeNames: ['Middle Kingdom of Egypt'], canonicalSummary: '约公元前2055—前1650年，由底比斯王室重新统一埃及后形成，并以文学、王权重组和后期政治分裂留下鲜明证据的政治实体。', timeSpan: timeSpan(-2055, -1650, '约公元前2055—前1650年', true), defaultCardId: 'egypt-middle-kingdom-overview', tags: ['非洲', '古埃及', '政治实体'], sourceIds: ['source-ucl-middle-kingdom', 'source-met-middle-kingdom', 'source-uee-second-intermediate'] },
    { id: 'egypt-new-kingdom', type: 'polity', name: '古埃及新王国', alternativeNames: ['New Kingdom of Egypt'], canonicalSummary: '约公元前1550—前1069年，从重新统一走向跨区域扩张，并经历阿玛尔纳改革、拉美西斯时代和晚期收缩的古埃及政治实体。', timeSpan: timeSpan(-1550, -1069, '约公元前1550—前1069年', true), defaultCardId: 'egypt-new-kingdom-overview', tags: ['非洲', '古埃及', '政治实体'], sourceIds: ['source-met-new-kingdom', 'source-hayes-scepter-ii'] },
    { id: 'egypt-pyramids', type: 'wonder', name: '古埃及金字塔', alternativeNames: ['Egyptian pyramids'], canonicalSummary: '古埃及以王室墓葬为核心发展出的石造建筑群，形状、施工组织与后续祭祀经历了长期变化。', timeSpan: timeSpan(-2700, -2200, '约公元前27—前23世纪', true), defaultCardId: 'egypt-pyramids-kingdom-at-work', tags: ['非洲', '古埃及', '奇观', '建筑'], sourceIds: ['source-met-old-kingdom', 'source-ucl-pyramid-shape', 'source-ucl-pyramids-overview'] },
    { id: 'egyptian-religion', type: 'Religous_and_Myth', name: '古埃及宗教', alternativeNames: ['Ancient Egyptian religion'], canonicalSummary: '通过身体保存、供奉、咒语、众神与审判来理解死亡和重生的一组长期宗教与神话传统。', timeSpan: timeSpan(-2686, -1069, '古王国至新王国', true), defaultCardId: 'egypt-afterlife-journey', tags: ['非洲', '古埃及', '宗教与神话', '死后世界'], sourceIds: ['source-ucl-burial-customs', 'source-ucl-religious-texts', 'source-bm-afterlife-journey'] },
    { id: 'egyptian-art', type: 'artStyle', name: '古埃及艺术', alternativeNames: ['Ancient Egyptian art'], canonicalSummary: '用人物朝向、大小、服饰、姿势、名字和材料表现身份、权力、祭祀与永生的一套长期视觉传统。', timeSpan: timeSpan(-2700, -1100, '古王国至新王国', true), defaultCardId: 'egyptian-art-identity-eternity', tags: ['非洲', '古埃及', '艺术风格'], sourceIds: ['source-met-ancient-egypt-art', 'source-arnold-pyramids', 'source-met-akhenaten-city'] },
    { id: 'egyptian-hieroglyphs', type: 'writingSystem', name: '古埃及象形文字', alternativeNames: ['Egyptian hieroglyphs'], canonicalSummary: '把词、辅音和帮助判断词义的无声符号组合起来记录古埃及语的书写系统。', timeSpan: timeSpan(-3100, 400, '约公元前3100年至公元4世纪', true), defaultCardId: 'egyptian-hieroglyphs-words-sounds', tags: ['非洲', '古埃及', '文字系统', '语言'], sourceIds: ['source-ucl-hieroglyphic-system', 'source-ucl-writing-development', 'source-ucl-coptic'] }
  ];

  const events = [
    {
      id: 'event-old-kingdom-fragmentation', title: '古王国统一王权瓦解', timeSpan: timeSpan(-2250, -2181, '约公元前23—前22世纪', true), participantEntityIds: ['egypt-old-kingdom'],
    ...
    {
      id: 'event-middle-kingdom-reunification', title: '孟图霍特普二世重新统一埃及', timeSpan: timeSpan(-2055, -2040, '约公元前21世纪', true), participantEntityIds: ['egypt-middle-kingdom'],
    ...
    {
      id: 'event-middle-kingdom-fragmentation', title: '中王国统一王权结束', timeSpan: timeSpan(-1700, -1650, '约公元前18—前17世纪', true), participantEntityIds: ['egypt-middle-kingdom'],
    ...
    {
      id: 'event-ahmose-captures-avaris', title: '雅赫摩斯攻下阿瓦里斯', timeSpan: timeSpan(-1555, -1545, '约公元前1550年', true), participantEntityIds: ['egypt-new-kingdom'],
    ...
    {
      id: 'event-amarna-reform', title: '阿肯那顿建立阿玛尔纳新秩序', timeSpan: timeSpan(-1353, -1336, '约公元前1353—前1336年', true), participantEntityIds: ['egypt-new-kingdom'],
    ...
    {
      id: 'event-battle-of-kadesh', title: '卡迭石战役', timeSpan: timeSpan(-1274, -1274, '约公元前1274年', true), participantEntityIds: ['egypt-new-kingdom', 'hittite-empire'],
    ...
    {
      id: 'event-egypt-hatti-treaty', title: '埃及与赫梯签订和平条约', timeSpan: timeSpan(-1259, -1258, '约公元前1259年', true), participantEntityIds: ['egypt-new-kingdom', 'hittite-empire'],
    ...
    {
      id: 'event-new-kingdom-fragmentation', title: '新王国统一王权结束', timeSpan: timeSpan(-1186, -1069, '约公元前1186—前1069年', true), participantEntityIds: ['egypt-new-kingdom'],
    ...
    {
      id: 'event-khufu-great-pyramid-construction', title: '胡夫大金字塔工程', timeSpan: timeSpan(-2580, -2560, '约公元前26世纪', true), participantEntityIds: ['egypt-old-kingdom', 'egypt-pyramids'],
    ...
    {
      id: 'event-unas-pyramid-text-inscription', title: '乌尼斯金字塔铭文刻写', timeSpan: timeSpan(-2375, -2325, '约公元前24世纪', true), participantEntityIds: ['egypt-old-kingdom', 'egypt-pyramids', 'egyptian-religion'],
  ...
  const additionalCards = [
    {
      id: 'egyptian-art-identity-eternity', kind: 'thematic', primaryEntityId: 'egyptian-art', relatedEntityIds: ['egypt-old-kingdom', 'egypt-new-kingdom', 'egyptian-religion', 'egypt-pyramids'], eventIds: ['event-amarna-reform'], title: '古埃及人把身份画进永恒',
    ...
    {
      id: 'egyptian-hieroglyphs-words-sounds', kind: 'thematic', primaryEntityId: 'egyptian-hieroglyphs', relatedEntityIds: ['egypt-old-kingdom', 'egypt-middle-kingdom', 'egypt-new-kingdom', 'egyptian-religion', 'egypt-pyramids'], eventIds: ['event-unas-pyramid-text-inscription'], title: '象形文字写下词与声音',
  ...
  const cards = [
    {
      id: 'ancient-egypt-gift-of-nile', kind: 'overview', primaryEntityId: 'ancient-egypt-civilization', relatedEntityIds: ['egypt-old-kingdom', 'egypt-middle-kingdom', 'egypt-new-kingdom', 'egypt-pyramids', 'egyptian-religion', 'egyptian-art', 'egyptian-hieroglyphs', 'late-bronze-palace-system', 'medinet-habu-war-records'], eventIds: ['event-khufu-great-pyramid-construction', 'event-old-kingdom-fragmentation', 'event-middle-kingdom-reunification', 'event-ahmose-captures-avaris', 'event-amarna-reform', 'event-new-kingdom-fragmentation', 'event-ramesses-iii-northern-invasions'], title: '尼罗河的赠礼',
    ...
    {
      id: 'egypt-old-kingdom-overview', kind: 'overview', primaryEntityId: 'egypt-old-kingdom', relatedEntityIds: ['egypt-middle-kingdom', 'egypt-pyramids', 'egyptian-religion'], eventIds: ['event-old-kingdom-fragmentation', 'event-khufu-great-pyramid-construction', 'event-unas-pyramid-text-inscription'], title: '金字塔背后的古王国',
    ...
    {
      id: 'egypt-middle-kingdom-overview', kind: 'overview', primaryEntityId: 'egypt-middle-kingdom', relatedEntityIds: ['egypt-old-kingdom', 'egypt-new-kingdom'], eventIds: ['event-middle-kingdom-reunification', 'event-middle-kingdom-fragmentation'], title: '重新统一的中王国',
    ...
    {
      id: 'egypt-new-kingdom-overview', kind: 'overview', primaryEntityId: 'egypt-new-kingdom', relatedEntityIds: ['egypt-middle-kingdom'], eventIds: ['event-ahmose-captures-avaris', 'event-amarna-reform', 'event-battle-of-kadesh', 'event-egypt-hatti-treaty', 'event-new-kingdom-fragmentation'], title: '法老把权力伸向远方',
    ...
    {
      id: 'egypt-pyramids-kingdom-at-work', kind: 'thematic', primaryEntityId: 'egypt-pyramids', relatedEntityIds: ['egypt-old-kingdom', 'egyptian-religion'], eventIds: ['event-khufu-great-pyramid-construction', 'event-unas-pyramid-text-inscription'], title: '一座金字塔需要整个王国',
    ...
    {
      id: 'egypt-afterlife-journey', kind: 'thematic', primaryEntityId: 'egyptian-religion', relatedEntityIds: ['egypt-old-kingdom', 'egypt-middle-kingdom', 'egypt-new-kingdom', 'egypt-pyramids'], eventIds: ['event-unas-pyramid-text-inscription'], title: '死亡以后，旅程才开始',
  ...
  const scenes = [
    {
      id: 'ancient-egypt-two-lands', title: '两片土地成为一个王国', eyebrow: '文明的政治起点', timeSpan: timeSpan(-3300, -2686, '约公元前3300—前2686年', true),
    ...
    {
      id: 'ancient-egypt-river-returns', title: '河水每年回来', eyebrow: '尼罗河的赠礼', timeSpan: timeSpan(-3100, -30, '约公元前3100—前30年', true),
    ...
    {
      id: 'ancient-egypt-pyramid-kingdom', title: '金字塔让整个王国忙起来', eyebrow: '古王国的工程', timeSpan: timeSpan(-2686, -2181, '约公元前2686—前2181年', true),
    ...
    {
      id: 'ancient-egypt-visible-identity', title: '文字和图像让身份被看见', eyebrow: '文字与艺术', timeSpan: timeSpan(-3100, -30, '约公元前3100—前30年', true),
    ...
    {
      id: 'ancient-egypt-dead-needs', title: '死者仍需要身体、名字和食物', eyebrow: '宗教与死后世界', timeSpan: timeSpan(-2686, -30, '约公元前2686—前30年', true),
    ...
    {
      id: 'ancient-egypt-reunifications', title: '王国分裂，又重新合在一起', eyebrow: '分裂与重建', timeSpan: timeSpan(-2181, -1550, '约公元前2181—前1550年', true),
    ...
    {
      id: 'ancient-egypt-power-far-away', title: '法老把权力伸向远方', eyebrow: '新王国的世界', timeSpan: timeSpan(-1550, -1069, '约公元前1550—前1069年', true),
    ...
    {
      id: 'ancient-egypt-survives-palaces', title: '宫殿熄灭以后，埃及仍然继续', eyebrow: '青铜时代危机以后', timeSpan: timeSpan(-1250, -30, '约公元前1250—前30年', true),
    ...
    {
      id: 'egypt-old-two-lands', title: '一位国王戴上两顶王冠', eyebrow: '古王国之前', timeSpan: timeSpan(-3150, -3050, '约公元前3150—前3050年', true),
    ...
    {
      id: 'egypt-old-pyramids-horizon', title: '金字塔登上地平线', eyebrow: '第三至第四王朝', timeSpan: timeSpan(-2686, -2490, '约公元前2686—前2490年', true),
    ...
    {
      id: 'egypt-old-afterlife-road', title: '为死后的旅程写下道路', eyebrow: '第五王朝', timeSpan: timeSpan(-2375, -2345, '约公元前2375—前2345年', true),
    ...
    {
      id: 'egypt-old-officials', title: '国王之外的办事人', eyebrow: '第六王朝', timeSpan: timeSpan(-2345, -2181, '约公元前2345—前2181年', true),
    ...
    {
      id: 'egypt-old-north-south', title: '命令不再通向所有地方', eyebrow: '古王国结束以后', timeSpan: timeSpan(-2250, -2055, '约公元前2250—前2055年', true),
    ...
    {
      id: 'egypt-middle-thebes-reunifies', title: '国王从南方出发', eyebrow: '第十一王朝', timeSpan: timeSpan(-2055, -2010, '约公元前2055—前2010年', true),
    ...
    {
      id: 'egypt-middle-sinuhe-home', title: '辛奴赫逃走，又回到埃及', eyebrow: '中王国文学', timeSpan: timeSpan(-2000, -1800, '约公元前2000—前1800年', true),
    ...
    {
      id: 'egypt-middle-avaris', title: '埃及再次出现几个中心', eyebrow: '中王国以后', timeSpan: timeSpan(-1700, -1550, '约公元前1700—前1550年', true),
    ...
    {
      id: 'egypt-new-ahmose-avaris', title: '战争带来新王朝', eyebrow: '第十八王朝开始', timeSpan: timeSpan(-1555, -1525, '约公元前1555—前1525年', true),
    ...
    {
      id: 'egypt-new-beyond-borders', title: '法老把命令送到远方', eyebrow: '第十八王朝', timeSpan: timeSpan(-1550, -1350, '约公元前1550—前1350年', true),
    ...
    {
      id: 'egypt-new-hatshepsut', title: '哈特谢普苏特成为法老', eyebrow: '第十八王朝', timeSpan: timeSpan(-1479, -1458, '约公元前1479—前1458年', true),
    ...
    {
      id: 'egypt-new-amarna-letters', title: '外国国王把法老叫作兄弟', eyebrow: '阿玛尔纳时期', timeSpan: timeSpan(-1353, -1336, '约公元前1353—前1336年', true),
    ...
    {
      id: 'egypt-new-akhenaten-city', title: '阿肯那顿要求埃及敬奉阿顿', eyebrow: '阿玛尔纳时期', timeSpan: timeSpan(-1353, -1336, '约公元前1353—前1336年', true),
    ...
    {
      id: 'egypt-new-kadesh', title: '拉美西斯把卡迭石写成胜利', eyebrow: '拉美西斯二世时期', timeSpan: timeSpan(-1274, -1258, '约公元前1274—前1258年', true),
    ...
    {
      id: 'egypt-new-contraction', title: '给法老修墓的人停工了', eyebrow: '第二十王朝晚期', timeSpan: timeSpan(-1186, -1069, '约公元前1186—前1069年', true),
    ...
    {
      id: 'egypt-pyramid-stone-grows', title: '石墓开始往天上长', eyebrow: '左塞尔的阶梯金字塔', timeSpan: timeSpan(-2700, -2630, '约公元前2700—前2630年', true),
    ...
    {
      id: 'egypt-pyramid-sneferu-three', title: '一位法老建了三座', eyebrow: '斯尼夫鲁的工程试验', timeSpan: timeSpan(-2630, -2580, '约公元前2630—前2580年', true),
    ...
    {
      id: 'egypt-pyramid-whole-complex', title: '一座金字塔不止有一座塔', eyebrow: '吉萨建筑群', timeSpan: timeSpan(-2600, -2450, '约公元前2600—前2450年', true),
    ...
    {
      id: 'egypt-pyramid-merer-boats', title: '梅勒的船今天又出发了', eyebrow: '胡夫统治晚期', timeSpan: timeSpan(-2580, -2560, '约公元前2580—前2560年', true),
    ...
    {
      id: 'egypt-pyramid-workers-city', title: '金字塔脚下也有一座城', eyebrow: '吉萨工人聚落', timeSpan: timeSpan(-2600, -2500, '约公元前2600—前2500年', true),
    ...
    {
      id: 'egypt-pyramid-feeding-city', title: '先让所有人吃上饭', eyebrow: '工地的供应网络', timeSpan: timeSpan(-2600, -2500, '约公元前2600—前2500年', true),
    ...
    {
      id: 'egypt-pyramid-cult-continues', title: '法老下葬了，工作还没结束', eyebrow: '持续多代的祭祀', timeSpan: timeSpan(-2600, -2200, '约公元前2600—前2200年', true),
    ...
    {
      id: 'egypt-pyramid-walls-speak', title: '石墙开始说话', eyebrow: '乌尼斯金字塔', timeSpan: timeSpan(-2375, -2325, '约公元前2375—前2325年', true),
    ...
    {
      id: 'egypt-afterlife-wah-wrapped', title: '瓦赫被一层层包好', eyebrow: '中王国的底比斯', timeSpan: timeSpan(-2000, -1900, '约公元前2000—前1900年', true),
    ...
    {
      id: 'egypt-afterlife-many-parts', title: '一个人不只是一具身体', eyebrow: '名字、心与生命力量', timeSpan: timeSpan(-2000, -1100, '约公元前2000—前1100年', true),
    ...
    {
      id: 'egypt-afterlife-offerings-continue', title: '墓门关上，饭还要送来', eyebrow: '活人与死者继续来往', timeSpan: timeSpan(-2200, -1100, '约公元前2200—前1100年', true),
    ...
    {
      id: 'egypt-afterlife-pyramid-spells', title: '咒语先写在国王的石墙上', eyebrow: '古王国晚期', timeSpan: timeSpan(-2375, -2325, '约公元前2375—前2325年', true),
    ...
    {
      id: 'egypt-afterlife-coffin-texts', title: '文字搬进了棺材', eyebrow: '中王国', timeSpan: timeSpan(-2050, -1750, '约公元前2050—前1750年', true),
    ...
    {
      id: 'egypt-afterlife-travel-guide', title: '一本带进墓里的旅行指南', eyebrow: '新王国的纸草卷', timeSpan: timeSpan(-1550, -1069, '约公元前1550—前1069年', true),
    ...
    {
      id: 'egypt-afterlife-gods-on-road', title: '众神在路上各有事情', eyebrow: '向导、榜样与主人', timeSpan: timeSpan(-1550, -1069, '约公元前1550—前1069年', true),
    ...
    {
      id: 'egypt-afterlife-heart-trial', title: '心脏不能说谎', eyebrow: '审判大厅', timeSpan: timeSpan(-1550, -1069, '约公元前1550—前1069年', true),
    ...
    {
      id: 'egypt-afterlife-field-work', title: '死后的田野也要下地干活', eyebrow: '理想的来世田野', timeSpan: timeSpan(-1550, -1069, '约公元前1550—前1069年', true),
    ...
    {
      id: 'egypt-art-images-work', title: '图像也有工作要做', eyebrow: '图像的用途', timeSpan: timeSpan(-2700, -1100, '约公元前2700—前1100年', true),
    ...
    {
      id: 'egypt-art-composite-body', title: '身体一次朝向好几个方向', eyebrow: '完整的人体', timeSpan: timeSpan(-1550, -1069, '约公元前1550—前1069年', true),
    ...
    {
      id: 'egypt-art-size-status', title: '谁最大，谁最重要', eyebrow: '大小与地位', timeSpan: timeSpan(-2458, -2446, '约公元前2458—前2446年', true),
    ...
    {
      id: 'egypt-art-statues-live', title: '雕像替主人继续活着', eyebrow: '墓中的身份', timeSpan: timeSpan(-2345, -2181, '约公元前2345—前2181年', true),
    ...
    {
      id: 'egypt-art-hatshepsut-pharaoh', title: '哈特谢普苏特穿上法老的形象', eyebrow: '女性法老', timeSpan: timeSpan(-1479, -1458, '约公元前1479—前1458年', true),
    ...
    {
      id: 'egypt-art-amarna-motion', title: '阿玛尔纳让王室动起来', eyebrow: '阿肯那顿的时代', timeSpan: timeSpan(-1353, -1336, '约公元前1353—前1336年', true),
    ...
    {
      id: 'egypt-art-abu-simbel-scale', title: '拉美西斯把自己刻得像山一样高', eyebrow: '阿布辛贝大神庙', timeSpan: timeSpan(-1279, -1213, '约公元前1279—前1213年', true),
    ...
    {
      id: 'egypt-hieroglyph-narmer-name', title: '石板上写着国王的名字', eyebrow: '文字进入王权图像', timeSpan: timeSpan(-3150, -3050, '约公元前3150—前3050年', true),
    ...
    {
      id: 'egypt-hieroglyph-word-sound', title: '一幅图既可以是词，也可以是声音', eyebrow: '一套混合书写系统', timeSpan: timeSpan(-2400, -2200, '约公元前2400—前2200年', true),
    ...
    {
      id: 'egypt-hieroglyph-silent-guides', title: '不出声的符号也在帮助阅读', eyebrow: '词义与阅读方向', timeSpan: timeSpan(-2700, -1100, '约公元前2700—前1100年', true),
    ...
    {
      id: 'egypt-hieroglyph-stone-papyrus', title: '石墙上的字，纸草上的字', eyebrow: '正式书写与日常手写', timeSpan: timeSpan(-2000, -1600, '约公元前2000—前1600年', true),
    ...
    {
      id: 'egypt-hieroglyph-language-changes', title: '语言变了，书写也跟着变化', eyebrow: '世俗体与科普特文字', timeSpan: timeSpan(-700, 400, '约公元前700—公元400年', true),
    ...
    {
      id: 'egypt-hieroglyph-alphabet-road', title: '一头牛的名字变成了一个声音', eyebrow: '通向早期字母', timeSpan: timeSpan(-1900, -1500, '约公元前1900—前1500年', true),
  ...
  const assets = [
    { id: 'asset-egypt-old-giza-pyramids', type: 'image', src: 'assets/images/ancient-egypt/old-kingdom-giza-pyramids.jpg', title: '吉萨三座大金字塔', alt: '沙漠地平线上的胡夫、哈夫拉与孟卡拉金字塔实景照片，三座金字塔按远近排列。', sourceIds: ['source-wikimedia-giza-pyramids'] },
    { id: 'asset-egypt-old-unas-pyramid-texts', type: 'image', src: 'assets/images/ancient-egypt/old-kingdom-unas-pyramid-texts.jpg', title: '乌尼斯金字塔墓室内的文字', alt: '乌尼斯金字塔墓室的历史照片，成列象形文字覆盖在石壁表面。', sourceIds: ['source-wikimedia-unas-pyramid-texts'] },
    { id: 'asset-egypt-old-mitry-statue', type: 'image', src: 'assets/images/ancient-egypt/old-kingdom-mitry-statue.jpg', title: '官员米特里的木雕像', alt: '彩绘木雕表现站立的官员米特里，他短发、赤裸上身，穿着白色短裙。', sourceIds: ['source-met-mitry-statue'] },
    { id: 'asset-egypt-middle-sinuhe-papyrus', type: 'image', src: 'assets/images/ancient-egypt/middle-kingdom-sinuhe-papyrus.jpg', title: '《辛奴赫的故事》纸草摹本', alt: '横向展开的纸草摹本上排列着多行黑色僧侣体文字。', sourceIds: ['source-wikimedia-sinuhe-papyrus'] },
    { id: 'asset-egypt-new-hatshepsut', type: 'image', src: 'assets/images/ancient-egypt/new-kingdom-hatshepsut.jpg', title: '哈特谢普苏特坐像', alt: '哈特谢普苏特的浅色石雕坐像，头戴王巾，双手平放在膝上。', sourceIds: ['source-met-hatshepsut'] },
    { id: 'asset-egypt-new-amarna-letter', type: 'image', src: 'assets/images/ancient-egypt/new-kingdom-amarna-letter.jpg', title: '阿玛尔纳书信泥板', alt: '一块小型长方形泥板，正面覆盖着密集的楔形文字。', sourceIds: ['source-met-amarna-letter-object'] },
    { id: 'asset-egypt-new-akhenaten', type: 'image', src: 'assets/images/ancient-egypt/new-kingdom-akhenaten.jpg', title: '阿肯那顿向阿顿献祭', alt: '彩绘石灰岩浮雕表现阿肯那顿手持鸭子献祭，上方太阳圆盘的光线末端伸出小手。', sourceIds: ['source-met-akhenaten-duck'] },
    { id: 'asset-egypt-new-strike-papyrus', type: 'image', src: 'assets/images/ancient-egypt/new-kingdom-strike-papyrus.jpg', title: '都灵罢工纸草', alt: '横向展开的棕色纸草残卷装裱在玻璃框内，纸面写满深色僧侣体文字，右侧有几块分离的残片。', sourceIds: ['source-turin-strike-papyrus'] },
    { id: 'asset-egypt-pyramid-djoser-step', type: 'image', src: 'assets/images/ancient-egypt/djoser-step-pyramid.jpg', title: '左塞尔阶梯金字塔', alt: '萨卡拉沙漠中的左塞尔阶梯金字塔实景，六层石台逐级向上收窄。', sourceIds: ['source-wikimedia-djoser-step'] },
    { id: 'asset-egypt-pyramid-bent-angle', type: 'image', src: 'assets/images/ancient-egypt/bent-pyramid-angle.jpg', title: '达舒尔弯曲金字塔', alt: '弯曲金字塔从近处仰望的实景，塔身在较高位置明显改变坡度。', sourceIds: ['source-wikimedia-bent-pyramid'] },
    { id: 'asset-egypt-pyramid-oarsmen-relief', type: 'image', src: 'assets/images/ancient-egypt/pyramid-oarsmen-official-met.jpg', title: '古王国船运浮雕。船上的大型货物可能是石块或建筑构件；这件浮雕并不直接描绘梅勒的船队。', alt: '一块古王国石灰岩浮雕，上部刻着奋力划船的船员和绑在甲板上的大型货物，下部是一名站立的官员。', sourceIds: ['source-met-oarsmen-official', 'source-wikimedia-oarsmen-official'] },
    { id: 'asset-egypt-pyramid-giza-complex-map', type: 'image', src: 'assets/images/ancient-egypt/pyramid-giza-complex-map.png', title: '吉萨金字塔建筑群地图；左侧的“Builders’ quarters”标出建造者居住区。', alt: '吉萨金字塔建筑群英文地图，标出三座主要金字塔、神庙、堤道、墓地、采石场、狮身人面像与建造者居住区。', sourceIds: ['source-wikimedia-giza-complex-map'] },
    { id: 'asset-egypt-pyramid-offering-bearers', type: 'image', src: 'assets/images/ancient-egypt/old-kingdom-offering-bearers.jpg', title: '运送食物的古王国人物模型', alt: '古王国彩绘木质人物模型，多名人物排成一列，用篮筐和容器运送食物与物资。', sourceIds: ['source-met-offering-bearers'] },
    { id: 'asset-egypt-false-door-neferiu', type: 'image', src: 'assets/images/ancient-egypt/false-door-neferiu.jpg', title: '尼费里乌的假门', alt: '石灰岩墓葬假门上刻有人物、供品与象形文字，为死者接受供奉提供象征通道。', sourceIds: ['source-met-neferiu-false-door'] },
    { id: 'asset-egypt-afterlife-wah-statuette', type: 'image', src: 'assets/images/ancient-egypt/statuette-of-wah.jpg', title: '瓦赫的小雕像', alt: '中王国管仓库者瓦赫的彩绘木雕立像，人物穿白色亚麻衣站立。', sourceIds: ['source-met-wah-statuette'] },
    { id: 'asset-egypt-afterlife-heart-scarab', type: 'image', src: 'assets/images/ancient-egypt/heart-scarab.jpg', title: '心形圣甲虫护身符', alt: '深绿色石制心形圣甲虫护身符，背部呈甲虫形状，底面刻有文字。', sourceIds: ['source-met-heart-scarab'] },
    { id: 'asset-egypt-afterlife-ukhhotep-coffin', type: 'image', src: 'assets/images/ancient-egypt/ukhhotep-0.jpg', title: '乌赫霍特普的外棺', alt: '中王国木棺完全展开的博物馆照片，内外表面绘有人物、物品并写满成行文字。', sourceIds: ['source-met-ukhhotep-coffin'] },
    { id: 'asset-egypt-afterlife-nesiamun-book-dead', type: 'image', src: 'assets/images/ancient-egypt/book-of-dead-nesiamun-original.jpg', title: '内西亚蒙的《亡灵书》纸草卷', alt: '横向展开的新王国纸草卷，上方有多行文字，下方绘制死者、众神和仪式场景。', sourceIds: ['source-met-nesiamun-book-dead'] },
    { id: 'asset-egypt-afterlife-hatnefer-osiris', type: 'image', src: 'assets/images/ancient-egypt/osiris-figure-hatnefer.jpg', title: '哈特奈弗墓中的奥西里斯像', alt: '小型木质奥西里斯立像，神戴高冠、身体包裹成木乃伊形状，双手交叉在胸前。', sourceIds: ['source-met-hatnefer-osiris'] },
    { id: 'asset-egypt-afterlife-anubis-weighing-heart', type: 'image', src: 'assets/images/ancient-egypt/anubis-weighing-heart.jpg', title: '阿努比斯称量心脏', alt: '纸草画面中胡狼头的阿努比斯站在天平旁，监督死者心脏的称量。', sourceIds: ['source-met-anubis-weighing-heart'] },
    { id: 'asset-egypt-afterlife-seti-shabti', type: 'image', src: 'assets/images/ancient-egypt/shabti-seti-i.jpg', title: '塞提一世的沙布提小像', alt: '蓝绿色人形陪葬小像双臂交叉，手中握着用于来世劳动的工具。', sourceIds: ['source-met-seti-i-shabti'] },
    { id: 'asset-egypt-art-anubis-facsimile', type: 'image', src: 'assets/images/ancient-egypt/anubis-weighing-heart.jpg', title: '阿努比斯称量心脏（现代1:1摹本）', alt: '现代等比例摹本重现古埃及纸草画面：胡狼头的阿努比斯站在天平旁，人物的脸与双腿朝向侧面，眼睛与肩膀更接近正面。', sourceIds: ['source-met-anubis-weighing-heart'] },
    { id: 'asset-egypt-art-sahure', type: 'image', src: 'assets/images/ancient-egypt/old-kingdom-sahure-statue.jpg', title: '法老萨胡拉与地方神祇', alt: '深色石雕中，戴王巾的法老萨胡拉端坐在高大王座上，一位体量较小的地方神祇站在他身旁。', sourceIds: ['source-met-sahure-statue'] },
    { id: 'asset-egypt-art-abu-simbel-color', type: 'image', src: 'assets/images/ancient-egypt/art-abu-simbel-color.jpg', title: '阿布辛贝大神庙正面', alt: '彩色照片中，阿布辛贝大神庙从赭色岩山中凿出，入口两侧排列着四尊巨大的拉美西斯二世坐像。', sourceIds: ['source-wikimedia-abu-simbel-color'] },
    { id: 'asset-egypt-hieroglyph-narmer', type: 'image', src: 'assets/images/ancient-egypt/hieroglyph-narmer-palette.jpg', title: '纳尔迈尔石板', alt: '灰绿色石板正面刻着头戴白冠的纳尔迈尔举起权杖，国王头顶的宫殿形边框中写有他的名字。', sourceIds: ['source-wikimedia-narmer-palette-cc0'] },
    { id: 'asset-egypt-hieroglyph-coptic', type: 'image', src: 'assets/images/ancient-egypt/hieroglyph-coptic-manuscript.jpg', title: '科普特语羊皮纸手稿', alt: '一张棕黄色的科普特语手稿残页，墨写字母排成多行，字形接近希腊字母。', sourceIds: ['source-met-coptic-manuscript'] },
    { id: 'asset-egypt-hieroglyph-champollion-table', type: 'image', src: 'assets/images/ancient-egypt/hieroglyph-champollion-table.jpg', title: '商博良1822年的语音符号对照表', alt: '一张黑白历史表格把多种世俗体写法和象形文字符号按语音分行排列；这是商博良研究解读文字时制作的表格，并非古埃及人使用的字母表。', sourceIds: ['source-wikimedia-champollion-table-pd'] },
    { id: 'asset-egypt-hieroglyph-karnak-color', type: 'image', src: 'assets/images/ancient-egypt/hieroglyph-karnak-color.jpg', title: '卡尔纳克神庙梁柱上的彩色文字', alt: '仰视照片中，两根巨柱之间的石梁保留着彩色象形文字；鸟、人和其他图形朝着特定方向排列。', sourceIds: ['source-wikimedia-karnak-hieroglyphs'] },
    { id: 'asset-egypt-old-unas-exterior', type: 'image', src: 'assets/images/ancient-egypt/old-kingdom-unas-exterior.jpg', title: '今天的乌尼斯金字塔', alt: '萨卡拉遗址中的乌尼斯金字塔如今像一座低矮的沙石丘，前方仍能看到建筑墙体和散落石块。', sourceIds: ['source-wikimedia-unas-exterior'] },
    { id: 'asset-egypt-hieroglyph-alphabet-chart', type: 'image', src: 'assets/images/ancient-egypt/hieroglyph-egyptian-to-sinaitic-chart.png', title: '埃及象形文字到原始西奈文字示意图（简化且有推测）', alt: '彩色表格从左到右排列埃及象形文字、原始西奈文字、腓尼基字母、古希腊字母和拉丁字母，第一行显示牛头图形逐渐变成字母A的过程。', sourceIds: ['source-thinkzone-alphabet-chart'] }
  ];
