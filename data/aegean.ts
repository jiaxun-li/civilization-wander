...
type Collection<Name extends keyof ContentModuleCollectionMap> = ContentModuleCollectionMap[Name];
  ...
  const assets: Collection<'assets'> = [
    ...
    { id: 'asset-aegean-knossos-linear-b', type: 'image', src: 'assets/images/aegean/crete-knossos-linear-b.webp', title: '克诺索斯线形文字B泥版KN Fp 13', alt: '一块横长的克诺索斯泥版写有密集的线形文字B，记录向若干神祇提供的油；照片完整保留泥版外形。', sourceIds: ['source-wikimedia-knossos-linear-b'] },
    { id: 'asset-aegean-crete-postpalatial-krater', type: 'image', src: 'assets/images/aegean/crete-postpalatial-krater.webp', title: '克里特后宫殿时期陶制混酒器', alt: '一件公元前1200至前1100年的克里特陶器，浅色器身上绘有持矛人物、野山羊与骑手，显示宫殿结束后的制作与图像传统。', sourceIds: ['source-wikimedia-mouliana-krater'] },
    { id: 'asset-aegean-mycenae-gold-mask', type: 'image', src: 'assets/images/aegean/mycenae-grave-circle-mask.webp', title: '迈锡尼墓圈A金面具；传统称“阿伽门农面具”', alt: '一张从迈锡尼墓圈A出土的金制葬仪面具正面照片；“阿伽门农面具”是后起传统名称，不是对墓主身份的确认。', sourceIds: ['source-wikimedia-mycenae-gold-mask'] },
    { id: 'asset-aegean-mycenae-athena-tablet', type: 'image', src: 'assets/images/aegean/mycenae-athena-linear-b.webp', title: '迈锡尼线形文字B泥版中的雅典娜神名', alt: '迈锡尼出土的浅褐色线形文字B泥版横置在深色背景中，铭文包含“雅典娜领受”，为宫殿献祭名单中的神名实例。', sourceIds: ['source-wikimedia-mycenae-athena-tablet'] },
    { id: 'asset-aegean-mycenae-warrior-krater', type: 'image', src: 'assets/images/aegean/mycenae-warrior-krater.webp', title: '约公元前1200年的迈锡尼战士陶瓶', alt: '迈锡尼卫城出土的陶制混酒器上画着列队出征的持盾战士；它是晚期迈锡尼物质图像，并非《伊利亚特》情节插图。', sourceIds: ['source-wikimedia-mycenae-warrior-krater'] },
    { id: 'asset-aegean-protogeometric-amphora', type: 'image', src: 'assets/images/aegean/dark-age-protogeometric-amphora.webp', title: '原几何风格陶制双耳罐', alt: '一件深浅相间的原几何风格陶罐，器肩以规整的同心圆和带状纹饰装饰，体现宫殿之后的制陶技术与地区风格。', sourceIds: ['source-wikimedia-protogeometric-amphora'] },
    { id: 'asset-aegean-naxos-geometric-pottery', type: 'image', src: 'assets/images/aegean/dark-age-naxos-geometric-pottery.webp', title: '约公元前830—前800年的纳克索斯几何陶器', alt: '纳克索斯出土的几何风格陶器完整陈列，器身分带绘有重复几何纹样，提供公元前九世纪末爱琴海地方风格的实例。', sourceIds: ['source-wikimedia-naxos-geometric-pottery'] },
    { id: 'asset-aegean-gods-rhea-cronus', type: 'image', src: 'assets/images/aegean/gods-rhea-cronus.webp', title: '瑞亚以襁褓中的石头欺骗克洛诺斯', alt: '1878年公共领域插画：瑞亚把包裹成婴儿的石头递给坐在王座上的克洛诺斯；这是后世对神话的想象，并非青铜时代图像。', sourceIds: ['source-wikimedia-rhea-cronus'] },
    { id: 'asset-aegean-gods-three-realms', type: 'image', src: 'assets/images/aegean/gods-three-realms.webp', title: '宙斯、波塞冬与哈得斯分掌世界', alt: '十六世纪公共领域版画：三位持权杖的神祇并列在天空、海洋与地下世界的象征之间；画面属于后世欧洲艺术传统。', sourceIds: ['source-wikimedia-three-realms'] },
    { id: 'asset-aegean-gods-council-met', type: 'image', src: 'assets/images/aegean/gods-council-met.webp', title: '雅各波·佐博利《众神会议》', alt: '大都会艺术博物馆藏公共领域素描以清晰线条横向排列云端众神；中央神祇彼此示意，两侧人物携带武器、权杖与动物等属性，呈现共享空间却各有立场的神界群体。', sourceIds: ['source-wikimedia-council-gods-met'] },
    { id: 'asset-aegean-gods-zeus-libation', type: 'image', src: 'assets/images/aegean/gods-zeus-libation.webp', title: '古希腊陶器上的宙斯与伊里斯献酒场景', alt: '约公元前五世纪陶器画中，宙斯端坐并持盛酒器，伊里斯在旁参与仪式；照片完整显示器物图像区域。', sourceIds: ['source-wikimedia-zeus-iris-libation'] },
    { id: 'asset-aegean-gods-demeter-persephone', type: 'image', src: 'assets/images/aegean/gods-demeter-persephone.webp', title: '约翰·迪克森·巴顿笔下的德墨忒尔与珀耳塞福涅', alt: '公共领域插画描绘母女在植物环绕的地面重逢；这是后世对季节神话的视觉诠释。', sourceIds: ['source-wikimedia-demeter-persephone-batten'] },
    { id: 'asset-aegean-gods-athena-achilles', type: 'image', src: 'assets/images/aegean/gods-athena-achilles.webp', title: '雅典娜按住愤怒的阿喀琉斯', alt: '公共领域书籍插画：全副武装的雅典娜从后方制止正要拔剑的阿喀琉斯，表现神直接介入英雄选择的时刻。', sourceIds: ['source-wikimedia-athena-achilles-illustration'] },
    { id: 'asset-aegean-heroes-mycenae-lion-gate-clear', type: 'image', src: 'assets/images/aegean/heroes-mycenae-lion-gate-clear.webp', title: '迈锡尼狮子门与巨石城墙', alt: '高清照片从进城道路完整呈现迈锡尼狮子门、三角浮雕和向山坡延伸的巨石城墙；道路与门洞提供尺度参照，突出青铜时代遗迹远超普通房屋的体量。', sourceIds: ['source-wikimedia-mycenae-lion-gate-clear'] },
    { id: 'asset-aegean-heroes-demodocus', type: 'image', src: 'assets/images/aegean/heroes-demodocus.webp', title: '歌者德摩多科斯在奥德修斯面前演唱', alt: '约翰·弗拉克斯曼1810年公共领域线描：歌者持琴坐在听众之间，奥德修斯掩面聆听关于特洛伊的歌。', sourceIds: ['source-wikimedia-demodocus-flaxman'] },
    { id: 'asset-aegean-heroes-achilles-thetis', type: 'image', src: 'assets/images/aegean/heroes-achilles-thetis.webp', title: '阿喀琉斯与海中女神忒提斯', alt: '弗里德里希·普雷勒之子创作的公共领域绘画：凡人英雄阿喀琉斯在海边面对神圣母亲忒提斯，强调他的双重出身。', sourceIds: ['source-wikimedia-achilles-thetis-preller'] },
    { id: 'asset-aegean-heroes-heracles-lion', type: 'image', src: 'assets/images/aegean/heroes-heracles-lion.webp', title: '古希腊陶器上的赫拉克勒斯与涅墨亚狮子', alt: '约公元前520—前500年的陶器画中，赫拉克勒斯徒手扼住狮子，旁人和武器围绕搏斗场面。', sourceIds: ['source-wikimedia-heracles-lion-bm'] },
    { id: 'asset-aegean-heroes-argonauts-leaving-colchis', type: 'image', src: 'assets/images/aegean/heroes-argonauts-leaving-colchis.webp', title: '埃尔科莱·德·罗贝尔蒂《阿尔戈英雄离开科尔基斯》', alt: '约1480年的公共领域绘画清楚描绘一艘扬帆大船，十余名披甲或着长袍的人物共同站在甲板和船舷内；这是文艺复兴时期对阿尔戈英雄集体远航的想象。', sourceIds: ['source-wikimedia-argonauts-roberti'] },
    { id: 'asset-aegean-heroes-oedipus-sphinx', type: 'image', src: 'assets/images/aegean/heroes-oedipus-sphinx.webp', title: '居斯塔夫·莫罗《俄狄浦斯与斯芬克斯》', alt: '1864年公共领域绘画：斯芬克斯攀附在直立的俄狄浦斯身上，两者近距离对视；这是后世对英雄、怪物与命运的诠释。', sourceIds: ['source-wikimedia-oedipus-sphinx-moreau'] },
    { id: 'asset-aegean-heroes-achilles-hector', type: 'image', src: 'assets/images/aegean/heroes-achilles-hector.webp', title: '阿喀琉斯击杀赫克托耳', alt: '十九世纪公共领域或CC0绘画表现阿喀琉斯与赫克托耳在特洛伊城外决斗；它是后世艺术想象，不是战争的同时代记录。', sourceIds: ['source-wikimedia-achilles-hector-groeninge'] },
    { id: 'asset-aegean-heroes-odysseus-return', type: 'image', src: 'assets/images/aegean/heroes-odysseus-return.webp', title: '平图里基奥《奥德修斯归来》', alt: '1509年公共领域绘画把奥德修斯回到家园后的识别与重逢安排在开阔室内外空间中，呈现归乡故事的后世视觉传统。', sourceIds: ['source-wikimedia-odysseus-return-pinturicchio'] },
    { id: 'asset-aegean-troy-vi-walls', type: 'image', src: 'assets/images/aegean/troy-vi-walls.webp', title: '特洛伊VI城墙遗迹', alt: '现代照片完整展示特洛伊遗址向外倾斜的厚重石墙、转角与沿墙通道，帮助辨认晚青铜时代设防城市仍留在土丘上的建筑层。', sourceIds: ['source-wikimedia-troy-vi-walls'] },
    { id: 'asset-aegean-troy-wilusa-treaty', type: 'image', src: 'assets/images/aegean/troy-wilusa-treaty.webp', title: '穆瓦塔利二世与阿拉克桑杜条约泥版', alt: '特洛伊博物馆陈列的竖长褐色泥版复制品完整入镜，表面密布楔形文字；条约把维鲁萨国王阿拉克桑杜写进赫梯外交网络。', sourceIds: ['source-wikimedia-troy-wilusa-treaty'] },
    { id: 'asset-aegean-iliad-flaxman-title', type: 'image', src: 'assets/images/aegean/iliad-flaxman-title.webp', title: '弗拉克斯曼《伊利亚特》版画集扉页', alt: '1795年开放许可版画扉页以古典线描和题名引出《伊利亚特》；这是十八世纪对史诗的视觉整理，并非青铜时代图像。', sourceIds: ['source-wikimedia-flaxman-iliad-title'] },
    { id: 'asset-aegean-iliad-thetis-zeus', type: 'image', src: 'assets/images/aegean/iliad-thetis-zeus.webp', title: '忒提斯向宙斯请求帮助', alt: '弗拉克斯曼设计、皮罗利1795年镌刻的公共领域线描中，忒提斯跪在宙斯座前替阿喀琉斯请求让希腊人暂时失败；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-iliad-thetis-zeus'] },
    { id: 'asset-aegean-iliad-embassy-achilles', type: 'image', src: 'assets/images/aegean/iliad-embassy-achilles.webp', title: '希腊使者劝说阿喀琉斯复战', alt: '弗拉克斯曼设计的1795年公共领域线描表现使者来到阿喀琉斯住处劝和，人物围坐交谈；这是后世对史诗情节的清晰分场。', sourceIds: ['source-wikimedia-flaxman-iliad-embassy'] },
    { id: 'asset-aegean-iliad-patroclus-body', type: 'image', src: 'assets/images/aegean/iliad-patroclus-body.webp', title: '双方争夺帕特罗克洛斯遗体', alt: '弗拉克斯曼设计的1795年公共领域线描以横向战斗队列表现希腊人与特洛伊人争夺帕特罗克洛斯遗体；它是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-iliad-patroclus'] },
    { id: 'asset-aegean-iliad-new-armor', type: 'image', src: 'assets/images/aegean/iliad-new-armor.webp', title: '忒提斯把新铠甲带给阿喀琉斯', alt: '弗拉克斯曼设计的1795年公共领域线描表现忒提斯与海中女神带来新盾和铠甲，悲痛的阿喀琉斯准备重新出战；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-iliad-armor'] },
    { id: 'asset-aegean-iliad-hector-body', type: 'image', src: 'assets/images/aegean/iliad-hector-body.webp', title: '阿喀琉斯拖走赫克托耳遗体', alt: '弗拉克斯曼设计的1795年公共领域线描中，阿喀琉斯的战车拖着赫克托耳遗体绕过特洛伊城下；这是后世对复仇情节的表现。', sourceIds: ['source-wikimedia-flaxman-iliad-hector'] },
    { id: 'asset-aegean-iliad-priam-achilles', type: 'image', src: 'assets/images/aegean/iliad-priam-achilles.webp', title: '普里阿摩斯走进阿喀琉斯营帐', alt: '弗拉克斯曼设计的1795年公共领域线描表现老王普里阿摩斯跪在阿喀琉斯面前赎回儿子遗体，侍从与赎金位于两侧；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-iliad-priam'] },
    { id: 'asset-aegean-troy-hector-funeral', type: 'image', src: 'assets/images/aegean/troy-hector-funeral.webp', title: '特洛伊人为赫克托耳举行葬礼', alt: '弗拉克斯曼设计的1795年公共领域线描表现赫克托耳葬礼的人群与遗体；它属于后世《伊利亚特》视觉传统，不是遗址人物的同时代记录。', sourceIds: ['source-wikimedia-flaxman-iliad-funeral'] },
    { id: 'asset-aegean-odyssey-suitors', type: 'image', src: 'assets/images/aegean/odyssey-suitors.webp', title: '求婚者发现珀涅罗珀的织布计策', alt: '弗拉克斯曼1810年公共领域线描表现珀涅罗珀坐在织机前，求婚者围在身旁发现她白天织布、夜里拆线的拖延办法；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-odyssey-suitors'] },
    { id: 'asset-aegean-odyssey-calypso-release', type: 'image', src: 'assets/images/aegean/odyssey-calypso-release.webp', title: '赫尔墨斯命令卡吕普索放人', alt: '弗拉克斯曼1810年公共领域线描表现神使赫尔墨斯向卡吕普索传达释放奥德修斯的命令；这是后世对海岛囚居情节的插画。', sourceIds: ['source-wikimedia-flaxman-odyssey-hermes'] },
    { id: 'asset-aegean-odyssey-nausicaa', type: 'image', src: 'assets/images/aegean/odyssey-nausicaa.webp', title: '瑙西卡与侍女遇见海难者', alt: '弗拉克斯曼1810年公共领域线描表现费埃克斯公主瑙西卡和侍女在河边活动，准备帮助陌生的海难者；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-odyssey-nausicaa'] },
    { id: 'asset-aegean-odyssey-polyphemus', type: 'image', src: 'assets/images/aegean/odyssey-polyphemus.webp', title: '奥德修斯让独眼巨人喝酒', alt: '弗拉克斯曼1810年公共领域线描表现奥德修斯把酒递给独眼巨人波吕斐摩斯，同伴在洞穴一侧准备逃生；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-odyssey-polyphemus'] },
    { id: 'asset-aegean-odyssey-laestrygonians', type: 'image', src: 'assets/images/aegean/odyssey-laestrygonians.webp', title: '食人巨人袭击奥德修斯船队', alt: '弗拉克斯曼1810年公共领域线描表现莱斯特律戈涅斯统治者安提法忒斯与巨人袭击来访船员，帮助理解船队为何只剩一艘；这是后世插画。', sourceIds: ['source-wikimedia-flaxman-odyssey-antiphates'] },
    { id: 'asset-aegean-odyssey-circe', type: 'image', src: 'assets/images/aegean/odyssey-circe.webp', title: '奥德修斯请求喀耳刻恢复同伴', alt: '弗拉克斯曼1810年公共领域线描表现奥德修斯持剑面对女神喀耳刻，请她让被魔法变形的同伴恢复人身；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-odyssey-circe'] },
    { id: 'asset-aegean-odyssey-sirens', type: 'image', src: 'assets/images/aegean/odyssey-sirens.webp', title: '被绑在桅杆上的奥德修斯聆听塞壬', alt: '弗拉克斯曼1810年公共领域线描中，奥德修斯被绑在桅杆，封住耳朵的船员继续划船，塞壬从岸边歌唱；这是后世史诗插画。', sourceIds: ['source-wikimedia-flaxman-odyssey-sirens'] },
