window.ATLAS_STORIES = [
  {
    ...
    mechanism: "核心区",
    overviewRank: 1,
    question: "为什么关中能够反复成为王朝积累力量并向东方扩张的核心区？",
    eyebrow: "中国与内亚 · 核心区",
    title: "关中",
    ...
    features: [
      { type: "area", kind: "plain", label: "关中平原", rank: 1, lon: 108.2, lat: 34.45, rx: 2.25, ry: 0.62, dy: -8 },
      { type: "ridge", label: "秦岭", rank: 2, points: [[104.4, 33.65], [106.2, 33.45], [108.2, 33.5], [110.0, 33.75], [111.1, 33.9]], dy: 28 },
      { type: "ridge", label: "北山", rank: 3, points: [[105.2, 35.45], [107.2, 35.75], [109.2, 35.65], [110.3, 35.35]], dy: -18 },
      { type: "river", label: "渭河", rank: 2, points: [[104.2, 34.55], [106.0, 34.4], [107.6, 34.35], [109.1, 34.45], [110.25, 34.55]], dy: -16 },
      { type: "river", label: "泾河", rank: 3, points: [[107.5, 36.0], [107.8, 35.3], [108.2, 34.75], [108.55, 34.45]], dx: 20, dy: -10 },
      { type: "river", label: "黄河", rank: 2, points: [[110.2, 36.5], [110.45, 35.7], [110.25, 34.55], [110.7, 33.65], [111.25, 32.9]], dx: 24, dy: 6 }
    ],
    geography: {
    ...
    sections: [
      ...
      },
      {
        heading: "地缘政治",
        themes: [
          { heading: "核心区的积累能力", body: "受保护的核心区降低了敌军直接冲击政治中心的机会，使政权更容易积累人口、粮食与军队。" },
          { heading: "农业基础需要组织", body: "渭河平原提供农业基础；但这种生产力并非纯天然赠予，也依赖灌溉、人口组织和国家建设。" },
          { heading: "向东方投射力量", body: "有限的东向出口既是防线，也是出击通道。因此关中更像一个“有屏障的前进基地”，而不是只能自守的盆地。" }
        ]
      },
      {
        heading: "历史实例",
  ...
  },
  {
    ...
    mechanism: "通道",
    overviewRank: 1,
    question: "为什么一串绿洲节点能够控制穿越干旱地带的东西交通？",
    eyebrow: "中国与内亚 · 通道",
    title: "河西走廊",
    ...
    features: [
      { type: "area", kind: "plain", label: "河西走廊", rank: 1, lon: 99.2, lat: 39.25, rx: 4.8, ry: 0.62, dy: -8 },
      { type: "area", kind: "desert", label: "巴丹吉林沙漠", rank: 2, lon: 101.1, lat: 41.05, rx: 2.1, ry: 0.72, dy: -4 },
      { type: "ridge", label: "祁连山", rank: 2, points: [[93.5, 37.3], [96.0, 36.85], [98.5, 36.95], [100.8, 37.15], [103.3, 37.55]], dy: 30 },
      { type: "ridge", label: "龙首山—合黎山", rank: 3, points: [[96.2, 40.9], [98.6, 40.55], [100.5, 40.0], [102.5, 39.3]], dy: -18 },
      { type: "river", label: "石羊河", rank: 2, points: [[102.2, 37.25], [102.55, 37.9], [102.8, 38.6], [103.1, 39.25]], dx: 18, dy: -8 },
      { type: "river", label: "黑河", rank: 2, points: [[99.6, 37.1], [100.0, 38.0], [100.45, 38.95], [100.1, 40.0], [99.5, 41.0]], dx: 20, dy: -8 },
      { type: "river", label: "疏勒河", rank: 3, points: [[96.2, 37.5], [96.0, 38.4], [95.4, 39.2], [94.6, 40.0]], dx: -22, dy: -8 }
    ],
    geography: {
    ...
    sections: [
      ...
      },
      {
        heading: "地缘政治",
        themes: [
          { heading: "绿洲提供补给", body: "祁连山融水形成的绿洲为人口、商旅和军队提供水源与补给；周围的高山和荒漠又把东西交通压缩到较少路线，因此控制绿洲节点就能显著影响整个通道。" },
          { heading: "连续经营依赖补给", body: "绿洲使长距离交通成为可能，但节点之间仍隔着干旱地带，所以补给线脆弱、维护成本高。" },
          { heading: "贸易与军事共用网络", body: "它既是贸易通道也是军事走廊：商队、移民、宗教传播、驻军和征服往往使用同一空间网络。" }
        ]
      },
      {
        heading: "历史实例",
  ...
  },
  {
    ...
    mechanism: "盆地",
    overviewRank: 1,
    question: "为什么四川盆地容易维持区域政权，却难以持续向外扩张？",
    eyebrow: "中国与内亚 · 盆地",
    title: "四川盆地",
    ...
    features: [
      { type: "area", kind: "basin", label: "四川盆地", rank: 1, lon: 105.9, lat: 30.35, rx: 3.15, ry: 2.05, dy: 14 },
      { type: "area", kind: "plain", label: "成都平原", rank: 2, lon: 103.85, lat: 30.75, rx: 0.82, ry: 0.72, dx: -10, dy: -8 },
      { type: "ridge", label: "龙门山", rank: 2, points: [[102.7, 32.5], [103.2, 31.7], [103.55, 30.7], [103.4, 29.7]], dx: -25, dy: -6 },
      { type: "ridge", label: "大巴山", rank: 3, points: [[106.2, 32.7], [108.0, 32.5], [109.7, 32.2], [110.6, 31.7]], dy: -18 },
      { type: "ridge", label: "巫山", rank: 3, points: [[109.2, 31.5], [109.4, 30.8], [110.0, 30.3], [110.3, 29.7]], dx: 20, dy: -6 },
      { type: "river", label: "长江", rank: 2, points: [[104.6, 28.75], [105.7, 28.9], [106.55, 29.55], [107.8, 30.0], [109.0, 30.55], [110.8, 30.8]], dy: 22 },
      { type: "river", label: "岷江", rank: 2, points: [[103.6, 32.2], [103.65, 31.2], [103.95, 30.7], [103.85, 29.6], [104.0, 28.85]], dx: -22, dy: -8 },
      { type: "river", label: "嘉陵江", rank: 3, points: [[106.0, 33.0], [106.1, 32.0], [106.3, 31.0], [106.7, 30.2], [106.55, 29.55]], dx: 22, dy: -8 },
      { type: "river", label: "大渡河", rank: 3, points: [[102.1, 31.1], [102.6, 30.4], [103.1, 29.7], [103.75, 29.55]], dx: -20, dy: 12 }
    ],
    geography: {
    ...
    sections: [
      ...
      },
      {
        heading: "地缘政治",
        themes: [
          { heading: "内部资源基础", body: "内部农业和水利基础能养活较大人口，为地方政权提供财政与兵源。都江堰体现了人类工程如何放大成都平原的地理优势。" },
          { heading: "山地提高进入成本", body: "外围山地提高了大军进入和持续补给的成本，有限通道给防守方提供时间，也使外部政权必须先控制关键路线和补给节点。" },
          { heading: "屏障也限制对外投射", body: "同样的屏障也增加了四川政权向关中、华北或长江中下游长期投射兵力的成本。防守优势不等于进攻优势。" }
        ]
      },
      {
        heading: "历史实例",
