(function exposeLateBronzeAgeV4(root, factory) {
  ...
  const assets = [
    { id: 'asset-lba-hittite-hattusa-wall', type: 'image', src: 'assets/images/late-bronze-age/hittite-hattusa-wall.jpg', title: '哈图沙城墙的现代考古复原', alt: '安纳托利亚高原上以土坯和石基复原的一段赫梯城墙，城门和方形塔楼沿城墙排列。', sourceIds: ['source-wikimedia-hattusa-wall'] },
    { id: 'asset-lba-hittite-inandik-vase', type: 'image', src: 'assets/images/late-bronze-age/hittite-inandik-vase.jpg', title: '伊南德克浮雕陶器；它呈现早期赫梯的宫廷祭仪，而非王位冲突本身', alt: '一件大型红褐色四耳陶器，器身分层排列立体人物、乐师、祭仪与动物图像；它为理解早期赫梯的王权仪式提供同时代视觉参照。', sourceIds: ['source-wikimedia-inandik-vase'] },
    { id: 'asset-lba-hittite-aleppo-treaty', type: 'image', src: 'assets/images/late-bronze-age/hittite-aleppo-treaty.jpg', title: '赫梯大王与阿勒颇国王的条约泥版', alt: '一块竖长形浅褐色泥版，正面写满阿卡德语楔形文字，是赫梯管理叙利亚地方王国的条约实例。', sourceIds: ['source-wikimedia-aleppo-treaty'] },
    { id: 'asset-lba-hittite-hattusa-ruins', type: 'image', src: 'assets/images/late-bronze-age/hittite-hattusa-ruins.jpg', title: '哈图沙遗址中的比于卡亚区域', alt: '哈图沙高地遗址的石墙基础和起伏地面，远处是安纳托利亚高原的山地。', sourceIds: ['source-wikimedia-hattusa-ruins'] },
    { id: 'asset-lba-ugarit-palace', type: 'image', src: 'assets/images/late-bronze-age/ugarit-royal-palace.jpg', title: '乌加里特王宫遗址', alt: '乌加里特王宫遗址中成排的浅色石墙基础和房间轮廓，背景可见叙利亚海岸地区的植被。', sourceIds: ['source-wikimedia-ugarit-palace'] },
    { id: 'asset-lba-ugarit-law-tablet', type: 'image', src: 'assets/images/late-bronze-age/ugarit-royal-law-tablet.jpg', title: '乌加里特国王尼克美帕的阿卡德语法律泥版', alt: '一块竖长形灰褐色泥版布满楔形文字，下部压印有王朝印章，显示王宫以书面文件处理权利。', sourceIds: ['source-wikimedia-ugarit-law-tablet'] },
    { id: 'asset-lba-ugarit-uluburun-reconstruction', type: 'image', src: 'assets/images/late-bronze-age/ugarit-uluburun-reconstruction.jpg', title: '乌鲁布伦沉船与货舱复原；它展示同一贸易世界，并非乌加里特船只的复原', alt: '博物馆中的晚青铜时代商船剖面复原，甲板上有人物，船舱内密集堆放铜锭、陶罐和其他货物，表现海运货物如何共同装载。', sourceIds: ['source-wikimedia-uluburun-reconstruction'] },
    { id: 'asset-lba-ugarit-administrative-tablet', type: 'image', src: 'assets/images/late-bronze-age/ugarit-administrative-tablet.jpg', title: '乌加里特语行政泥版', alt: '一块不规则浅褐色泥版的正面照片，泥面排列着使用字母楔形文字书写的行政记录。', sourceIds: ['source-wikimedia-ugarit-admin-tablet'] },
    { id: 'asset-lba-pylos-linear-b-tablet', type: 'image', src: 'assets/images/late-bronze-age/pylos-linear-b-tablet.jpg', title: '皮洛斯宫殿的线形文字B泥版', alt: '一块横长的浅褐色泥版由数块残片拼合，表面分行刻写线形文字B；它记录牛、猪和鹿皮如何分配给制鞋与制鞍工匠，并因毁灭宫殿的火灾被烘硬保存。', sourceIds: ['source-wikimedia-pylos-linear-b-tablet'] },
    { id: 'asset-lba-ugarit-throne-hall', type: 'image', src: 'assets/images/late-bronze-age/ugarit-palace-throne-hall.jpg', title: '乌加里特王宫的王座大厅', alt: '乌加里特王宫遗址中一间由高大石墙围合的大厅，右侧现场标牌写有“王座大厅”；它让王宫作为统治空间的实体尺度清晰可见。', sourceIds: ['source-wikimedia-ugarit-throne-hall'] },
    { id: 'asset-lba-kadesh-spies-relief', type: 'image', src: 'assets/images/late-bronze-age/kadesh-spies-relief.png', title: '埃及浮雕中的被俘侦察人员', alt: '黑白浮雕画面中，埃及士兵控制并审问跪坐的人物；这一场面属于埃及王室对卡迭石战役的叙事。', sourceIds: ['source-wikimedia-kadesh-spies'] },
    { id: 'asset-lba-kadesh-surprise-map', type: 'image', src: 'assets/images/late-bronze-age/kadesh-surprise-attack.png', title: '卡迭石战车突袭英语教学图', alt: '英语教学地图以箭头表示赫梯战车渡过奥伦特河、冲击拉神军团与埃及营地，并标出仍在南方行进的埃及部队；位置与路线均为现代重建。', sourceIds: ['source-wikimedia-kadesh-attack-map', 'source-spalinger-war-egypt'] },
    { id: 'asset-lba-kadesh-ramesses-relief', type: 'image', src: 'assets/images/late-bronze-age/kadesh-ramesses-relief.jpg', title: '阿布辛贝神庙中的卡迭石浮雕', alt: '石墙浮雕表现拉美西斯二世乘战车迎战敌军；画面把法老置于战斗中心，是埃及王室塑造胜利记忆的一部分。', sourceIds: ['source-wikimedia-kadesh-relief'] },
    { id: 'asset-lba-kadesh-treaty-tablet', type: 'image', src: 'assets/images/late-bronze-age/kadesh-treaty-tablet.jpg', title: '埃及—赫梯条约的赫梯文泥版残片', alt: '伊斯坦布尔考古博物馆收藏的褐色楔形文字泥版残片，是埃及与赫梯条约的赫梯文版本之一。', sourceIds: ['source-wikimedia-kadesh-treaty'] },
    { id: 'asset-lba-amarna-mail-carrier', type: 'image', src: 'assets/images/late-bronze-age/amarna-mail-carrier-1915.png', title: '1915年书籍中的古埃及信使插图', alt: '1915年百科全书依据底比斯古画刊出的黑白线描：一名短发人物手持卷状物走向坐在柱廊中的官员；这是较早时期的后世插图，并非阿玛尔纳使者的现场记录。', sourceIds: ['source-runeberg-egypt-mail-carrier'] },
    { id: 'asset-lba-amarna-four-foreign-rulers', type: 'image', src: 'assets/images/late-bronze-age/amarna-four-foreign-rulers.jpg', title: '《四位外国统治者》新王国墓画摹本', alt: 'Norman de Garis Davies于1915年制作的蛋彩摹本，四位不同服饰的外国统治者面向埃及铭文与礼物；原画比阿玛尔纳时代更早，作为埃及宫廷表现外国统治者的参照。', sourceIds: ['source-met-four-foreign-rulers'] },
    { id: 'asset-lba-amarna-tushratta-marriage-letter', type: 'image', src: 'assets/images/late-bronze-age/amarna-tushratta-marriage-letter.jpg', title: '图什拉塔讨论王室婚姻与黄金的长信', alt: '一块高而宽的深褐色泥版布满密集楔形文字，并由横线分段；米坦尼国王图什拉塔在信中与阿蒙霍特普三世讨论王室婚姻、礼物和黄金。', sourceIds: ['source-wikimedia-tushratta-marriage-letter'] },
    { id: 'asset-lba-medinet-habu-temple', type: 'image', src: 'assets/images/late-bronze-age/medinet-habu-temple.jpg', title: '麦迪奈特哈布的拉美西斯三世祭庙', alt: '蓝天下的麦迪奈特哈布祭庙入口与高墙，墙面覆盖巨大的埃及浮雕和铭文。', sourceIds: ['source-wikimedia-medinet-habu-temple'] },
    { id: 'asset-lba-medinet-habu-naval-battle', type: 'image', src: 'assets/images/late-bronze-age/medinet-habu-naval-battle.jpg', title: '麦迪奈特哈布墙面上的尼罗河口海战', alt: '十九世纪照片记录的埃及浮雕细节，战船、弓箭手、落水者和倒伏人物密集交错。', sourceIds: ['source-wikimedia-medinet-habu-naval'] },
    { id: 'asset-lba-medinet-habu-ox-carts', type: 'image', src: 'assets/images/late-bronze-age/medinet-habu-ox-carts.png', title: '麦迪奈特哈布图版中的牛车与战士细节', alt: '芝加哥大学考古调查的整页黑白图版，上半左侧记录牛车细节，其他三格记录埃及和北方来敌的战士。', sourceIds: ['source-isac-medinet-habu-i', 'source-wikimedia-medinet-habu-land-battle'] }
  ];
