(function exposeAegeanV4(root, factory) {
  const data = factory();
  if (root) root.ATLAS_V4_AEGEAN = data;
  if (typeof module === 'object' && module.exports) module.exports = data;
}(typeof window !== 'undefined' ? window : globalThis, function createAegeanV4Data() {
  'use strict';

  function timeSpan(start, end, label, approximate) {
    const normalizedLabel = label === '约在公元前800年前形成' ? '约公元前1200—前800年' : label;
    const value = { start, end, label: normalizedLabel };
  ...
  const entities = [
    {
      ...
      timeSpan: timeSpan(-2000, -1100, '约公元前2000—前1100年', true), defaultCardId: 'crete-through-palatial-age',
    ...
    },
    {
      ...
      timeSpan: timeSpan(-1700, -1050, '约公元前1700—前1050年', true), defaultCardId: 'mycenae-graves-palaces-tablets',
    ...
    },
    {
      ...
      timeSpan: timeSpan(-1200, -800, '约公元前1200—前800年', true), defaultCardId: 'greece-reconnects-after-palaces',
    ...
    },
    {
      ...
      timeSpan: timeSpan(-1450, -800, '约公元前1450—前800年', true), defaultCardId: 'greek-gods-leave-palaces',
    ...
    },
    {
      ...
      timeSpan: timeSpan(-1600, -800, '约公元前1600—前800年', true), defaultCardId: 'greek-heroes-live-in-song',
    ...
    },
    {
      ...
      timeSpan: timeSpan(-1700, -800, '约公元前1700—前800年', true), defaultCardId: 'troy-layered-city',
    ...
    },
    {
      ...
      timeSpan: timeSpan(-1200, -800, '约公元前1200—前800年', true), defaultCardId: 'iliad-achilles-anger',
    ...
    },
    {
      ...
      timeSpan: timeSpan(-1200, -800, '约公元前1200—前800年', true), defaultCardId: 'odyssey-name-and-home',
  ...
  const events = [
    {
      id: 'event-crete-palaces-emerge-and-rebuild', title: '克里特宫殿出现并重建', timeSpan: timeSpan(-2000, -1450, '约公元前2000—前1450年', true),
    ...
    {
      id: 'event-knossos-linear-b-administration', title: '克诺索斯改用线形文字B', timeSpan: timeSpan(-1450, -1375, '约公元前1450—前1375年', true),
    ...
    {
      id: 'event-mycenaean-palace-administration', title: '迈锡尼宫殿行政扩展', timeSpan: timeSpan(-1450, -1200, '约公元前1450—前1200年', true),
    ...
    {
      id: 'event-mycenaean-palaces-end', title: '迈锡尼宫殿接连终结', timeSpan: timeSpan(-1250, -1180, '约公元前1250—前1180年', true),
    ...
    {
      id: 'event-aegean-localizes-after-palaces', title: '爱琴海社会转向地方社区', timeSpan: timeSpan(-1200, -1050, '约公元前1200—前1050年', true),
      participantEntityIds: ['mycenaean-civilization', 'greek-dark-age-communities'],
    ...
    {
      id: 'event-aegean-regional-links-renew', title: '爱琴海区域联系重新增密', timeSpan: timeSpan(-1050, -800, '约公元前1050—前800年', true),
    ...
    {
      id: 'event-troy-vi-viia-destruction', title: '特洛伊VI与VIIa经历毁坏和重建', timeSpan: timeSpan(-1700, -1180, '约公元前1700—前1180年', true),
    ...
    {
      id: 'event-hittite-wilusa-treaty', title: '赫梯大王与维鲁萨国王缔结条约', timeSpan: timeSpan(-1300, -1250, '约公元前1300—前1250年', true),
  ...
  const cards = [
    {
      ...
      eventIds: ['event-crete-palaces-emerge-and-rebuild', 'event-knossos-linear-b-administration'], title: '克里特岛走过宫殿时代',
    ...
    },
    {
      ...
      eventIds: ['event-knossos-linear-b-administration', 'event-mycenaean-palace-administration', 'event-mycenaean-palaces-end', 'event-aegean-localizes-after-palaces'], title: '墓穴、宫殿与泥板',
    ...
    },
    {
      ...
      eventIds: ['event-mycenaean-palaces-end', 'event-aegean-localizes-after-palaces', 'event-aegean-regional-links-renew'], title: '宫殿之后，希腊重新连接',
    ...
    },
    {
      ...
      eventIds: ['event-mycenaean-palace-administration', 'event-mycenaean-palaces-end'], title: '众神走出宫殿',
    ...
    },
    {
      ...
      eventIds: ['event-mycenaean-palaces-end', 'event-aegean-localizes-after-palaces', 'event-aegean-regional-links-renew'], title: '英雄活在歌声里',
    ...
    },
    {
      ...
      eventIds: ['event-troy-vi-viia-destruction', 'event-hittite-wilusa-treaty'], title: '高墙下的层层城市',
  ...
  const scenes = [
    {
      id: 'crete-court-palace-daily-life', title: '庭院装下宫殿的日常', eyebrow: '成熟宫殿文明', timeSpan: timeSpan(-2000, -1700, '约公元前2000—前1700年', true),
    ...
    {
      id: 'crete-linear-a-at-work', title: '线形文字A开始工作', eyebrow: '宫殿书写', timeSpan: timeSpan(-1900, -1450, '约公元前1900—前1450年', true),
    ...
    {
      id: 'crete-palaces-rebuild-seaward', title: '重建的宫殿望向海上', eyebrow: '重建与交换', timeSpan: timeSpan(-1700, -1450, '约公元前1700—前1450年', true),
    ...
    {
      id: 'crete-tablets-change-language', title: '泥版换了一种语言', eyebrow: '迈锡尼行政进入克里特', timeSpan: timeSpan(-1450, -1375, '约公元前1450—前1375年', true),
    ...
    {
      id: 'crete-palaces-end-island-continues', title: '宫殿结束，岛屿继续生活', eyebrow: '后宫殿时期', timeSpan: timeSpan(-1375, -1100, '约公元前1375—前1100年', true),
    ...
    {
      id: 'mycenae-gold-enters-graves', title: '黄金先进入墓穴', eyebrow: '宫殿以前', timeSpan: timeSpan(-1700, -1450, '约公元前1700—前1450年', true),
    ...
    {
      id: 'mycenae-linear-b-writes-greek', title: '线形文字B写下希腊语', eyebrow: '克里特书写传统', timeSpan: timeSpan(-1450, -1400, '约公元前1450—前1400年', true),
    ...
    {
      id: 'mycenae-palaces-write-needs', title: '宫殿把需要的事情写进泥板', eyebrow: '宫殿世界', timeSpan: timeSpan(-1400, -1200, '约公元前1400—前1200年', true),
    ...
    {
      id: 'mycenae-palaces-stop-commanding', title: '宫殿接连停止发令', eyebrow: '宫殿体系终结', timeSpan: timeSpan(-1250, -1180, '约公元前1250—前1180年', true),
    ...
    {
      id: 'mycenae-hero-stories-travel', title: '宫殿消失，英雄故事开始远行', eyebrow: '后宫殿记忆', timeSpan: timeSpan(-1180, -1050, '约公元前1180—前1050年', true),
    ...
    {
      id: 'dark-age-orders-stop-tablets', title: '命令停在烧硬的泥版上', eyebrow: '宫殿之后', timeSpan: timeSpan(-1200, -1050, '约公元前1200—前1050年', true),
    ...
    {
      id: 'dark-age-iron-enters-bronze-world', title: '铁器进入仍有青铜的世界', eyebrow: '技术与陶器', timeSpan: timeSpan(-1050, -900, '约公元前1050—前900年', true),
    ...
    {
      id: 'dark-age-sea-routes-return', title: '海路带着货物和故事回来', eyebrow: '重新连接', timeSpan: timeSpan(-900, -800, '约公元前900—前800年', true),
    ...
    {
      id: 'gods-names-enter-tablets', title: '泥版已经写下神的名字', eyebrow: '宫殿里的献祭', timeSpan: timeSpan(-1450, -1200, '约公元前1450—前1200年', true),
    ...
    {
      id: 'gods-survive-palaces', title: '宫殿消失，神没有离开', eyebrow: '口头传讲', timeSpan: timeSpan(-1200, -800, '约公元前1200—前800年', true),
    ...
    {
      id: 'gods-younger-overthrow-older', title: '新神推翻旧神', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'gods-three-brothers-divide-world', title: '三兄弟分掌世界', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'gods-olympus-quarrels', title: '奥林匹斯是一个争吵的家庭', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'gods-gifts-and-requests', title: '神要求祭品，也回应请求', eyebrow: '祭祀关系', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'gods-demeter-persephone-return', title: '季节、死亡与重新归来', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'gods-turn-to-heroes', title: '众神把目光投向英雄', eyebrow: '进入英雄时代', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'heroes-ruins-hold-stronger-past', title: '废墟留下一个更强大的过去', eyebrow: '青铜时代遗迹', timeSpan: timeSpan(-1600, -1200, '约公元前1600—前1200年', true),
    ...
    {
      id: 'heroes-singers-remake-lost-age', title: '歌者重新组织失去的时代', eyebrow: '口头表演', timeSpan: timeSpan(-1200, -800, '约公元前1200—前800年', true),
    ...
    {
      id: 'heroes-between-gods-and-mortals', title: '英雄站在神与凡人之间', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'heroes-monsters-wait', title: '怪物守在道路尽头', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'heroes-board-argo', title: '一群英雄登上同一条船', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'heroes-curses-cross-generations', title: '家族把诅咒传给下一代', eyebrow: '神话叙事', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'heroes-gather-at-troy', title: '英雄聚集在特洛伊城下', eyebrow: '通往《伊利亚特》', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'heroes-homecomings-continue', title: '战争结束，归乡仍未结束', eyebrow: '通往《奥德赛》', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'troy-walls-fall-city-rebuilds', title: '高墙倒下，城市再次重建', eyebrow: '特洛伊VI与VIIa', timeSpan: timeSpan(-1700, -1180, '约公元前1700—前1180年', true),
    ...
    {
      id: 'troy-wilusa-enters-treaty', title: '赫梯书吏把维鲁萨写进条约', eyebrow: '晚青铜时代外交', timeSpan: timeSpan(-1300, -1250, '约公元前1300—前1250年', true),
    ...
    {
      id: 'troy-ruins-gain-heroic-names', title: '废墟后来得到英雄的姓名', eyebrow: '进入英雄歌唱', timeSpan: timeSpan(-1180, -800, '约公元前1180—前800年', true),
    ...
    {
      id: 'iliad-singer-starts-near-war-end', title: '歌者从战争末期开始', eyebrow: '长期口头传讲', timeSpan: timeSpan(-1200, -800, '约公元前1200—前800年', true),
      contentBlocks: [
    ...
    {
      id: 'iliad-two-captives-start-quarrel', title: '两个俘虏引爆统帅之间的争吵', eyebrow: '阿喀琉斯的愤怒', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'iliad-achilles-lets-greeks-fail', title: '阿喀琉斯让自己人尝到失败', eyebrow: '荣誉变成伤亡', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'iliad-hector-reaches-ships', title: '赫克托耳把敌人逼回船边', eyebrow: '希腊军队败退', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'iliad-patroclus-wears-armor', title: '帕特罗克洛斯穿上朋友的铠甲', eyebrow: '朋友代替英雄出战', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'iliad-new-shield-returns-hero', title: '一面新盾把英雄送回战场', eyebrow: '悲痛转为复仇', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'iliad-hector-dies-outside-walls', title: '赫克托耳死在自己的城墙之外', eyebrow: '复仇抵达城下', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'iliad-priam-enters-enemy-camp', title: '失去儿子的父亲走进敌营', eyebrow: '《伊利亚特》的终点', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-return-songs-become-poem', title: '许多归乡歌汇成一部长诗', eyebrow: '长期口头传讲', timeSpan: timeSpan(-1200, -800, '约公元前1200—前800年', true),
      contentBlocks: [
    ...
    {
      id: 'odyssey-suitors-consume-house', title: '求婚者正在吃空奥德修斯的家', eyebrow: '伊塔卡的危机', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-calypso-releases-hero', title: '海上女神终于放走奥德修斯', eyebrow: '最后一次漂流', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-princess-leads-stranger', title: '一位公主把陌生人带进宫廷', eyebrow: '费埃克斯人的待客', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-nobody-defeats-cyclops', title: '他用“无人”战胜独眼巨人', eyebrow: '奥德修斯讲述漂泊', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-wind-bag-opens', title: '风袋在家乡岸外被打开', eyebrow: '船队接连失去', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-witch-and-dead-guide-home', title: '女巫与死者指出归途', eyebrow: '喀耳刻与冥界', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-songs-monsters-taboo-kill-crew', title: '歌声、怪物和禁令夺走所有同伴', eyebrow: '最后一艘船毁灭', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-beggar-enters-own-hall', title: '乞丐走进自己的宫室', eyebrow: '身份仍需隐藏', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
    ...
    {
      id: 'odyssey-bow-and-bed-restore-name', title: '弓弦与床榻恢复他的姓名', eyebrow: '归乡完成', timeDisplay: 'undatedNarrative', timeSpan: timeSpan(-1200, -800, '约在公元前800年前形成', true),
