(function exposeAncientChinaV5(root, factory) {
  ...
  const assets = [
    ...
    { id: 'asset-shang-oracle-collection', type: 'image', src: 'assets/images/ancient-china/shang-oracle-collection.webp', title: '成组陈列的商代卜骨', alt: '多块大小不同的商代牛骨卜辞在展柜中成组陈列，显示甲骨材料的碎裂与多样形态。', sourceIds: ['source-wikimedia-oracle-collection', 'source-unesco-oracle-bones'] },
    { id: 'asset-shang-bronze-casting-apparatus', type: 'image', src: 'assets/images/ancient-china/shang-bronze-casting-apparatus.webp', title: '殷墟铸铜工具与陶范陈列', alt: '殷墟博物馆中铸铜装置、陶范和相关工具的完整展柜照片，多个工序遗物并置可见。', sourceIds: ['source-wikimedia-bronze-casting-apparatus', 'source-smithsonian-bronze-casting'] },
